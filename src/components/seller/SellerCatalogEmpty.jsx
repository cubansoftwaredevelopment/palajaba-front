    ...
    <div className="relative mx-auto mb-5 flex h-28 w-full max-w-xs items-end justify-center">
      ...
      <div className="relative flex -space-x-3">
        <div className="flex h-20 w-16 flex-col items-center justify-center rounded-2xl border border-brand-green/15 bg-brand-white shadow-[0_8px_24px_rgba(89,128,44,0.1)]">
          <span className="font-display text-[0.65rem] font-bold text-brand-carmelita/70">Desp.</span>
          <span className="mt-1 text-[0.55rem] font-semibold text-brand-carmelita/70">Despensa</span>
        </div>
        <div className="flex h-24 w-16 flex-col items-center justify-center rounded-2xl border border-brand-green/18 bg-brand-yellow/12 shadow-[0_10px_28px_rgba(89,128,44,0.12)]">
          <span className="font-display text-[0.65rem] font-bold text-brand-green">Ofert.</span>
          <span className="mt-1 text-[0.55rem] font-semibold text-brand-green">Ofertas</span>
        </div>
        <div className="flex h-20 w-16 flex-col items-center justify-center rounded-2xl border border-brand-green/15 bg-brand-white shadow-[0_8px_24px_rgba(89,128,44,0.1)]">
          <span className="font-display text-[0.65rem] font-bold text-brand-carmelita/70">Nuevo</span>
          <span className="mt-1 text-[0.55rem] font-semibold text-brand-carmelita/70">Novedades</span>
        </div>
      </div>
    </div>
  )
